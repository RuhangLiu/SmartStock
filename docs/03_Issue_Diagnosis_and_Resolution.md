...
The application creates required folders and uses WAL mode. Azure remains limited to one App Service instance because this SQLite design is not intended for concurrent multi-instance writes.
